...
public class NavigateBlogAndToggleTheme {
    
    private static def execute_functional_method(Map data) {
        
        "Step 1: Click on header academicJourney2 -> Navigate to page 'blog post#blog/*'"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_blog/header_academicJourney2'))
        ...
        "Step 3: Click on header blogTitle2 -> Navigate to page 'blog post#blog/*'"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_blog/header_blogTitle2'))
