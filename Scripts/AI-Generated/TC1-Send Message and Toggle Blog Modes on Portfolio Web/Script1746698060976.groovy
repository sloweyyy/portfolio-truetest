...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 13-Click on button blog.png')

"Step 14: Access blog posts and toggle between light and dark modes"
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 15-Click on div sloWey - Navigate to page .png')

"Step 16: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Send Message and Toggle Blog Modes on Portfolio Web_visual_checkpoint')
