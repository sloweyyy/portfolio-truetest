...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 2-Click on header pageTitle.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 3-Click on div skillDescription.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 4-Click on div skillDescription.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 5-Click on div skillDescription.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 6-Click on button resume2 - Navigate to page resumeresume.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 7-Click on button contact.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 8-Click on input name.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 9-Click on div contactForm.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 10-Click on button viewPdf - Navigate to page .png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Check Skills and Contact Information_visual_checkpoint')
