...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 2-Click on image enigma.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 3-Click on image fiveDcoffee.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 4-Click on div enigmaMobileDevelopment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 5-Click on image musicify.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 6-Click on span object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 7-Click on span object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 8-Click on span y.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 9-Click on span object3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 10-Click on span object4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 11-Click on span object5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 12-Click on span object5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 13-Click on span object6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 14-Click on button blog - Navigate to page blogblog.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 15-Click on p discoverJourney - Navigate to page .png')

"Step 16: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Explore Portfolio Projects and Verify Home Page_visual_checkpoint')
