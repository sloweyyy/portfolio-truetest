...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 2-Click on button resume - Navigate to page resumeresume.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 3-Click on div profileSummary.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 4-Click on div skillsOverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 5-Click on div container.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 6-Click on div container.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 7-Click on div container.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 8-Click on div container.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 9-Click on div container.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 10-Click on button home - Navigate to page .png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 11-Click on div skilledInTech.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 12-Click on button resume - Navigate to page resumeresume.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 13-Click on div productSupportEngineer.png')

"Step 14: Click on item coordinateWithTeams"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'resume?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_resume/item_coordinateWithTeams'))

WebUI.takeScreenshot(reportLocation + '/TC13/Step 14-Click on item coordinateWithTeams.png')

"Step 15: Click on item coordinateWithTeams"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'resume?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_resume/item_coordinateWithTeams'))

WebUI.takeScreenshot(reportLocation + '/TC13/Step 15-Click on item coordinateWithTeams.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 16-Click on button linkedIn.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 17-Click on div backendEngineerFocus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 18-Click on span letter letterO.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 19-Click on span letter letterT.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 20-Click on div fullProfileSummary.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 21-Click on span letterA.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 22-Click on div backendEngineerFocus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 23-Click on button viewPdf2 - Navigate to page .png')

"Step 24: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC13-View Comprehensive Resume and Profile on Portfolio Web_visual_checkpoint')
