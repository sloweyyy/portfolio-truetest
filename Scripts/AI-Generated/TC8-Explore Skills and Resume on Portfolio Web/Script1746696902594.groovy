...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 2-Click on div creative.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 3-Click on div passionate.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 4-Click on div dedicated.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 5-Click on div dedicated.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 6-Click on div skillDescription.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 7-Click on button object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 8-Click on button resume3 - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Explore Skills and Resume on Portfolio Web_visual_checkpoint')
