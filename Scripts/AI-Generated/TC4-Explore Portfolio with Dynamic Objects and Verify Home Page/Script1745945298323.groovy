...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 2-Click on image enigma.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 3-Click on image fiveDcoffee.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 5-Click on image musicify.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 6-Click on span object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 7-Click on span dynamicObject object7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 9-Click on span dynamicObject object8.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 11-Click on span object5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 12-Click on span object5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 13-Click on span object6.png')
...
"Step 15: Click on button blog2 -> Navigate to page 'blog#blog'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_home/button_blog2'))

WebUI.takeScreenshot(reportLocation + '/TC4/Step 15-Click on button blog2 - Navigate to page blogblog.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Explore Portfolio with Dynamic Objects and Verify Home Page_visual_checkpoint')
