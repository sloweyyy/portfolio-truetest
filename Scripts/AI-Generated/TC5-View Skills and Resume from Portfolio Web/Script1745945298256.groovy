...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 6-Click on button resume - Navigate to page resumeresume.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-View Skills and Resume from Portfolio Web_visual_checkpoint')
